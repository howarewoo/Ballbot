...
m = 10;         %Mass of Bot (lb)
b = 0;          %Friction (assume 0)
g = 32.1740;    %gravity (ft/s^2)
l = 0.3;        %Length to pendulum center mass
I = m*(l^2);    %Inertia
...
impulse(T,t)
axis([0, 2.5, -0.1, 0.1]);
title({'Response of Pendulum Position to an Impulse Disturbance';'under PID Control: Kp = 500, Ki = 1, Kd = 20'});
